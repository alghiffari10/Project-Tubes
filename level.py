...
class Level:
    def __init__(self,current_level,surface,create_overworld,change_coins,change_health):
        ...
        self.coins_sound.set_volume(0.3)
        ...
        for row_index, row in enumerate(layout):
            for col_index,val in enumerate(row):
                if val != '-1':
                    ...
                    if type == 'coins':
                        #interaksi antar object
                        if val == '0': sprite = Coin(tile_size,x,y,'coins/gold',5)
                        if val == '1': sprite = Coin(tile_size,x,y,'coins/silver',1)
    ...
    def player_setup(self,layout,change_health):
        for row_index, row in enumerate(layout):
            for col_index,val in enumerate(row):
                ...
                if val == '0':
                    #interaksi antar object
                    sprite = Player((x,y),self.__display_surface,self.create_jump_particles,change_health)
    ...
    def run(self):
        ...
        self.explosion_sprites.update(self.__world_shift)
        self.explosion_sprites.draw(self.__display_surface)
        #crates
